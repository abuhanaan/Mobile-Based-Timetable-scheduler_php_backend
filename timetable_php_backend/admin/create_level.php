<div class="container-fluid" style="opacity: 0.9">
    ...
    $('#submit_level').click(function (){
       ...
       $.post('./lib/connect.php?action=create_level',{input_level:input_level}, function(data, textStatus) {
    if(parseInt(data) == 1){
...
<label for="input_level" class="col-sm-5 control-label">Level:</label>
            <div class="col-sm-7">
  <input type="text" name="txtLexvel" value="" placeholder="Enter Level" id="input_level" class="form-control" />
                          </div>
          </div>
            ...
            <div class="col-sm-10">
		    <br>
                    <button type="button" class="btn btn-success btn-sm" id="submit_level" title="Save"><i class="glyphicon glyphicon-floppy-disk"> Save</i></button>
