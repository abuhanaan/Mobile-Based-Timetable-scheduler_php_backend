...
<div class="container-fluid" style="opacity: 0.9">
    ...
    $('#submit_course').click(function (){
       ...
       $.post('./lib/connect.php?action=create_course',{txtDepart:txtDepart,txtLevel:txtLevel, input_course:input_course, input_accr:input_accr}, function(data, textStatus) {
    if(parseInt(data) == 1){
...
<label for="input_level" class="col-sm-5 control-label">Select Level:</label>
                ...
                <div class="col-sm-7">
                <select name="txtCollege" class="form-control" id="txtLevel" >
            ...
            <div class="form-group ">
<label for="input_course" class="col-sm-5 control-label">Course Name:</label>
            <div class="col-sm-7">
  <input type="text" name="txtCourse" value="" placeholder="Enter Course Name" id="input_course" class="form-control" />
                          </div>
          </div>
           <div class="form-group ">
			<label class="col-sm-5 control-label" for="input_accr">Acronym:</label>
            <div class="col-sm-7">
        <input type="text" name="txtAccronym" value="" placeholder="Acronym" id="input_accr" class="form-control" />
                          </div>
          </div>
            <center>
		     <div class="form-group ">
